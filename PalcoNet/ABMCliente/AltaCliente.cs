    ...
    public partial class AltaCliente : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (!TextFieldUtils.IsAnyFieldEmpty(this))
            {
                ...
                inputParameters.AddParameter("@username", StringUtil.GenerateRandomUsername(4));
                inputParameters.AddParameter("@id_rol", 1); // CAMBIAR PRUEBA SOLO
                inputParameters.AddParameter("@password","123"); //Contraseña creada por defecto que luego debera ser cambiada por el usuario
